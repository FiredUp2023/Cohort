                        ...
                        {socials.map((social) => {
                            return (
                                ...
                                <div className="w-[200px]">
                                    <Input type='text' placeholder='Platform name... ' value={social.social} handleChange={(e) => setSocials(socials.map((s) => (s._id === social._id ? { ...s, social: e.target.value } : s)))}/>        
                                </div>
                                <div className="w-[400px] ml-2">
                                    <Input type='text' placeholder='Profile url...' value={social.url} handleChange={(e) => setSocials(socials.map((s) => (s._id === social._id ? { ...s, url: e.target.value } : s)))}/>        
                                </div>
                                </div>
                            )
                        })}
